...
const DEPLOYMENT_ENV = process.env.ENV ? 'development' : 'production';

const GLOBAL_CONFIG = {
    // System Constants
    // ============================================================

    APP_NAME: (packageInfo.name) || '<application-name>',
    APP_VERSION: (packageInfo.version) || '<application-version>',
...
const config = {
    development: {
        ...
        // DB Configs
        // ============================================================
        MONGODB_URI: process.env.DEV_MONGO_URL,
...
export default config[DEPLOYMENT_ENV];
